...
const Notification = () => {
    ...
    return (
        <>
            <div className={`z-10 transition-all ${isShow ? "translate-x-0" : "translate-x-full"} fixed top-0 right-0 bg-white ${type === 'success' ? 'border-[4px] border-solid border-green-500' : 'border-[4px] border-solid border-red-500'} w-fit h-fit rounded-md`}>
